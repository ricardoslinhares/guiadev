...
function ThemeToggle({ isDark, onToggle }) {
  return (
    <button onClick={onToggle} className="theme-toggle-btn p-2.5 rounded-lg transition-all duration-300 hover:scale-110 active:scale-95" aria-label={isDark ? 'Ativar tema claro' : 'Ativar tema escuro'} title={isDark ? 'Tema Claro ☀️' : 'Tema Escuro 🌙'}>
